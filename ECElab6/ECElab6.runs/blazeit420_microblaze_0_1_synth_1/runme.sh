...
HD_PWD='D:/ECE385/ECElab6/ECElab6.runs/blazeit420_microblaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blazeit420_microblaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blazeit420_microblaze_0_1.tcl
