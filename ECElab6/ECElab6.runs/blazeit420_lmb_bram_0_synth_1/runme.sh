...
HD_PWD='D:/ECE385/ECElab6/ECElab6.runs/blazeit420_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blazeit420_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blazeit420_lmb_bram_0.tcl
