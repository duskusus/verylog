...
################################################################
# This is a generated script based on design: redstone
#
...
proc create_root_design { parentCell } {
  ...
  set M01_AXI_0_ext [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M01_AXI_0_ext ]
  set_property -dict [ list \
  ...
  # Create ports
  set Clk_ext [ create_bd_port -dir O -type clk Clk_ext ]
  ...
  set s_axi_aclk_ext [ create_bd_port -dir O -type clk s_axi_aclk_ext ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M01_AXI_0_ext} \
 ] $s_axi_aclk_ext
  set s_axi_aresetn_ext [ create_bd_port -dir O -from 0 -to 0 -type rst s_axi_aresetn_ext ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_ports M01_AXI_0_ext] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_ports Clk_ext] [get_bd_ports s_axi_aclk_ext] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_ports s_axi_aresetn_ext] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x44A00000 -range 0x00040000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs M01_AXI_0_ext/Reg] -force
